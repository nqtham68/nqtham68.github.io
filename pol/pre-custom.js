...
if (enableAds)
{
    loadOrderScript('//imasdk.googleapis.com/js/sdkloader/ima3.js', 'adsSDK.js?v=0.0.9');
    // loadOrderScript('//imasdk.googleapis.com/js/sdkloader/ima3_debug.js', 'adsSDK.js');			
}
