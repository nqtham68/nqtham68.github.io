window.__require = function e(t, n, r) {
  ...
  game: [ function(require, module, exports) {
    ...
    var event_manager_1 = require("../core/event-manager");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var customMapKeys = [ "stime", "score1", "score2", "lasMoveSeq", "face", "team", "health", "bindFireId", "strength", "speed", "state", "throwVector", "progress", "dropTarget", "bindId", "time", "dir", "data", "action" ];
    var Game = function(_super) {
      ...
      Game.prototype.onNetEvent = function(event, data) {
        if (event == NetModules_1.NetEvent.DISCONNECT) {
